...
**Comment 10**: When the interface of a dependency is changed the package needs to be changed as well.
...
**Comment 11**: Think of a way to delegate the authorisation and authentication back to the resource owner. We would propose to change the way of passing credentials in the resource.

**Answer**: The resource owner also owns the resource definition in the Opal server.

**Comment 12**: Is it possible to restrict the usage of certain resources? For example, prohibit the use of resources.
