...
* The factory pattern, a classic [creational design pattern](https://en.wikipedia.org/wiki/Factory_method_pattern). It is realized by the ResourceResolver R6 class which is responsible for making a ResourceClient object matching a provided resource object.
