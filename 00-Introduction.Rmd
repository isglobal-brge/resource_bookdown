...
Finally, we would like to thank the Bioconductor core team for inspiring us to write this book. We follow the two succesful works describing how to Orchestrate [High-Throughput Genomic Analysis](https://pubmed.ncbi.nlm.nih.gov/25633503/) and [Single Cell Analysis](https://pubmed.ncbi.nlm.nih.gov/31792435/) with Bioconductor. 