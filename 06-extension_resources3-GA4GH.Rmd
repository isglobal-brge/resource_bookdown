...
A GA4GH htsget can be added to a project by a simple function call, building the URL as:
...
opal.resource_create(o, "RSRC", "GA4GH", 
...
opal.assign.resource(o, "client", "RSRC.GA4GH")
...
A EGA database can be added to a project by a simple function call, building the URL as:
...
To load the presented resources into the study servers, the standard procedure already presented on this Bookdown has to be followed.
...
conns <- datashield.login(logins = logindata, assign = TRUE,
                          symbol = "gagh")
datashield.assign.expr(conns, symbol = "gagh_gds", 
                       expr = quote(as.resource.object(gagh)))
```
